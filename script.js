...
(function () {
  ...
  var STUDIO = {
    name: 'Your Name',
    blurb: 'Paintings, prints, and the notes that went with them.',
    discipline: 'Painter & printmaker',
    range: 'Works and notes, 2019\u20132024',
    place: 'Studio \u00b7 Leeds',
  ...
  var WORKS = [
    {
      title: 'Still Water at Bramble Reach',
      meta: 'Oil on linen \u00b7 2024',
      plate: 'assets/still-water-at-bramble-reach.jpg',
      note: 'Out at six, before the wind got up. I worked standing with the tin balanced on a rock, and I let the hesitation stay in the paint \u2014 four passes over the water and it never quite dried.',
      bg: '#8a7a63',
      spec: { medium: 'Oil on linen', size: '90 \u00d7 70 cm', year: '2024' }
    },
    {
      title: 'Winter Kiln',
      meta: 'Charcoal and gouache \u00b7 2023',
      plate: null,
      note: 'Drawn from the far side of the yard in February. My hands stopped working long before I was finished, so the last third is fast and wrong on purpose.',
      bg: '#7d6b57',
      spec: { medium: 'Charcoal and gouache on paper', size: '42 \u00d7 30 cm', year: '2023' }
    },
    {
      title: 'Two Chairs, Late Light',
      meta: 'Oil on board \u00b7 2022',
      plate: null,
      note: 'Painted the same two chairs for eleven evenings. This is the ninth. The light only reaches the far wall for about twenty minutes, which turns out to be exactly the right amount of time.',
      bg: '#9a6a4f',
      spec: { medium: 'Oil on board', size: '60 \u00d7 45 cm', year: '2022' }
    },
    {
      title: 'Salt Flat Study',
      meta: 'Ink wash \u00b7 2021',
      plate: null,
      note: 'Twenty minutes of paper, one brush, no second attempt. The wash decided the horizon on its own, and I have stopped arguing with it.',
      bg: '#8f9188',
      spec: { medium: 'Ink wash on cotton paper', size: '28 \u00d7 38 cm', year: '2021' }
    },
    {
      title: 'The Long Field',
      meta: 'Oil on canvas \u00b7 2020',
      plate: null,
      note: 'Begun in the summer and abandoned, then worked over in November with a palette knife. You can see the summer underneath if you stand slightly to the left.',
      bg: '#77855f',
      spec: { medium: 'Oil on canvas', size: '120 \u00d7 80 cm', year: '2020' }
    },
    {
      title: 'Notes Toward Morning',
      meta: 'Monotype \u00b7 2019',
      plate: null,
      note: 'The first plate of the series and still the loosest one. Printed at the kitchen table, because the press was frozen solid in the studio.',
      bg: '#6f7c8c',
      spec: { medium: 'Monotype on Somerset', size: '35 \u00d7 50 cm', year: '2019' }
    }
  ];
    ...
    gallery.appendChild(node(
      '<figure class="g-card">' +
        ...
        '<figcaption>' +
          ...
          '<p class="g-note">' + esc(work.note) + '</p>' +
        '</figcaption>' +
      '</figure>'
    ));
  });
